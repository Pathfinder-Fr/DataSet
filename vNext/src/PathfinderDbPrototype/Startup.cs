        ...
        public void Configure(IBuilder app)
        {
            ...
            */
            ...
            app.UseServices(services =>
            {
                ...
                services.AddScoped<Models.PathfinderDbContext>();

                // Configure DbContext           
                services.SetupOptions<Models.IdentityDbContextOptions>(options =>
                        {
                ...
                services.SetupOptions<Models.PathfinderDbContextOptions>(options =>
                    options.UseSqlServer(configuration.Get("Data:DefaultConnection:ConnectionString")));

                // Add Identity services to the services container
                services.AddIdentitySqlServer<Models.ApplicationDbContext, Models.ApplicationUser>()
                        .AddHttpSignIn();
